            ...
            const questions = [
                {
                    name: 'employee',
                    type: 'list',
                    message: 'Which employee would have a change in role?',
                    choices: employees.map(employee => employee.first_name + ' ' + employee.last_name),
                    validate: userInput => {
                        if (userInput) {
                            return true;
                        } else {
                            console.log(`Please select and employee!`);
                            return false;
                        }
                    }
                },
...
module.exports = { getAllEmployees, addNewEmployee, updateEmployeeRole };